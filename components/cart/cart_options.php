                            ...
                            <?php foreach ($menu_options as $key => $menu_option) { ?>
                                <?php if ($menu_option['display_type'] == 'radio') { ?>
                                    <div class="option option-radio">
                                        <input type="hidden"
                                               name="menu_options[<?php echo $key; ?>][option_id]"
                                               value="<?php echo $menu_option['option_id']; ?>"/>
                                        <input type="hidden"
                                               name="menu_options[<?php echo $key; ?>][menu_option_id]"
                                               value="<?php echo $menu_option['menu_option_id']; ?>"/>
                                            ...
                                            <?php foreach ($menu_option['option_values'] as $option_value) { ?>
                                                ...
                                                <?php if (in_array($option_value['menu_option_value_id'], $cart_option_value_ids[$key]) OR (empty($cart_option_value_ids[$key]) AND $menu_option['default_value_id'] == $option_value['menu_option_value_id'])) { ?>
                                                    <div class="radio"><label>
                                                            <input type="radio"
                                                                   name="menu_options[<?php echo $key; ?>][option_values][]"
                                                                   value="<?php echo $option_value['option_value_id']; ?>"
                                                                   checked="checked"/>
                                                            <?php echo $option_value['value']; ?>
                                                            <span class="price small"><?php echo $option_value['price']; ?></span>
                                                        </label></div>
                                                <?php } else { ?>
                                                    <div class="radio"><label>
                                                            <input type="radio"
                                    ...
                                    <div class="option option-select">
                                        <div class="form-group clearfix">
                                            <div class="col-sm-5 wrap-none">
                                                ...
                                                <?php if (isset($menu_option['option_values'])) { ?>
                                                    <select name="menu_options[<?php echo $key; ?>][option_values][]"
                                                            class="form-control">
                                                        ...
                                                        <?php foreach ($menu_option['option_values'] as $option_value) { ?>
                                                            ...
                                                            <?php if (in_array($option_value['menu_option_value_id'], $cart_option_value_ids[$key]) OR (empty($cart_option_value_ids[$key]) AND $menu_option['default_value_id'] == $option_value['menu_option_value_id'])) { ?>
                                                                <option value="<?php echo $option_value['option_value_id']; ?>"
                                                                        data-subtext="<?php echo $option_value['price']; ?>"
                                                                        selected="selected">
                                                                    <?php echo $option_value['value']; ?>
                                                                </option>
                                                            <?php } else { ?>
                        ...
                        <div class="col-xs-12 col-md-6">
                            ...
                            <?php if ($row_id) { ?>
                                <a class="btn btn-success btn-block"
                                   onclick="addToCart('<?php echo $menu_id; ?>')"
                                   title="<?php echo lang('text_update'); ?>"><?php echo lang('button_update'); ?></a>
                            <?php } else { ?>
                                <a class="btn btn-success btn-block"
                                   onclick="addToCart('<?php echo $menu_id; ?>')"
                                   title="<?php echo lang('text_add_to_order'); ?>"><?php echo lang('button_add_to_order'); ?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
