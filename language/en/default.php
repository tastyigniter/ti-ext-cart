...
return [
    ...
    'column_title'    => 'Title',
//    'column_admin_title' => 'Admin Title',
    'column_display'  => 'Display total',
    ...
    'label_cart_totals'         => 'Cart Totals',
    'label_stock_checkout'      => 'Stock Checkout',
    'label_show_stock_warning'  => 'Show Stock Warning',

    'alert_menu_added'               => '<p class="alert-success">Menu has been added to your order.</p>',
    'alert_menu_updated'             => '<p class="alert-success">Menu has been updated successfully</p>',
    'alert_out_of_stock'             => '<p class="alert-warning">%s is currently out of stock.</p>',
    'alert_low_on_stock'             => '<p class="alert-warning">%s is currently low on stock, stock left is %s.</p>',
    'alert_minimum_qty'              => '<p class="alert-warning">%s minimum quantity is %s.</p>',
    'alert_bad_request'              => '<p class="alert-danger">Error occurred, please check and try again.</p>',
    'alert_unknown_error'            => '<p class="alert-danger">Error occurred, please check and try again.</p>',
    ...
    'alert_order_unavailable'        => '<p class="alert-danger">This restaurant is unavailable to take orders at the moment.</p>',
    'alert_delivery_unavailable'     => '<p class="alert-danger">This restaurant is unavailable to take delivery orders at the moment.</p>',
    'alert_collection_unavailable'   => '<p class="alert-danger">This restaurant is unavailable to take pick-up orders at the moment.</p>',
    'alert_delivery_coverage'        => '<p class="alert-danger">Sorry, but this restaurant does not deliver to your location</b>',
    'alert_min_delivery_order_total' => '<p class="alert-warning">Order total is below the minimum delivery order total. <br />You need to spend %s or more to order for delivery</p>',
    'alert_coupon_removed'           => '<p class="alert-success">Your coupon has been removed successfully.</p>',
    'alert_coupon_applied'           => '<p class="alert-success">Your coupon has been applied successfully.</p>',
    'alert_coupon_invalid'           => '<p class="alert-danger">Please enter a valid coupon.</p>',
    'alert_coupon_expired'           => '<p class="alert-danger">Your coupon is either invalid or expired.</p>',
    'alert_coupon_not_applied'       => '<p class="alert-danger">Your coupon can not be applied to orders below %s.</p>',
    'alert_coupon_maximum_reached'   => '<p class="alert-danger">Maximum number of redemption for the coupon has been reached.</p>',
    'alert_coupon_order_restriction' => '<p class="alert-danger">Your coupon can ONLY be applied to <b>%s</b> orders</p>',
    'alert_menu_not_within_mealtime' => '<p class="alert-warning">%s is available for %s ONLY between (%s - %s)</p>',
