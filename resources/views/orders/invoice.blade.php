...
<div class="container-fluid p-5">
    <div class="row">
        <div class="col">
            <div class="invoice-title">
                <h3 class="pull-right">@lang('igniter.cart::default.orders.label_order_id')
                    &nbsp;#{{$model->order_id}}</h3>
                <h2>@lang('igniter.cart::default.orders.text_invoice')</h2>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-6">
            <p>
                <strong>@lang('igniter.cart::default.orders.text_customer')</strong><br>
                {{ $model->first_name.' '.$model->last_name.' ('.$model->email.')' }}
            </p>
            @if($model->isDeliveryType())
                <div>
                    <strong>@lang('igniter.cart::default.orders.text_deliver_to')</strong><br>
        ...
        <div class="col-3 text-left">
            <p>
                <strong>@lang('igniter.cart::default.orders.text_invoice_no')</strong><br>
                {{ $model->invoice_number }}
            </p>
            <p>
                <strong>@lang('igniter.cart::default.orders.text_invoice_date')</strong><br>
                {{ $model->invoice_date->format(lang('igniter::system.php.date_format')) }}<br><br>
            </p>
        </div>
        <div class="col-3 text-right">
            <p>
                <strong>@lang('igniter.cart::default.orders.text_payment')</strong><br>
                {{ $model->payment_method ? $model->payment_method->name : '' }}
            </p>
            <p>
                <strong>@lang('igniter.cart::default.orders.text_order_date')</strong><br>
                {{ $model->order_date->setTimeFromTimeString($model->order_time)->format(lang('igniter::system.php.date_time_format')) }}
            </p>
        </div>
    </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th class="text-left" width="65%">
                            <b>@lang('igniter.cart::default.orders.column_name_option')</b>
                        </th>
                        <th class="text-left"><b>@lang('igniter.cart::default.orders.column_price')</b></th>
                        <th class="text-right"><b>@lang('igniter.cart::default.orders.column_total')</b></th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    @foreach($model->getOrderTotals() as $total)
                        ...
                        <tr>
                            <td class="{{ ($loop->iteration === 1 || $thickLine) ? 'thick' : 'no' }}-line"
                                width="1"></td>
    ...
    <div class="row">
        <div class="col">
            <p class="text-center">@lang('igniter.cart::default.orders.text_invoice_thank_you')</p>
        </div>
    </div>
</div>
</body>
