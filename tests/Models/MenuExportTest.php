...
it('returns empty array when no menu categories are defined', function() {
...
it('returns array with menu categories when defined', function() {
...
it('returns encoded array of menu categories', function() {
    $menuExport = mock(MenuExport::class)->makePartial();
...
it('configure menu export model correctly', function() {
    $menuExport = new MenuExport;
